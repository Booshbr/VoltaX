# AGENTS.md — VoltaX permanent project rules
...
spec lives in `VOLTAX — MASTER Codex BUILD PROMPT.md`.
...
- `lib/ai` — explanation service: deterministic templater (always) + Codex
